...
`;
  ...
  var frida_java_bridge_exports = {};
  __export(frida_java_bridge_exports, {
    default: () => frida_java_bridge_default
  });
  ...
  // ../../app/frida_hooks/sensitive_apis.js
  var require_sensitive_apis = __commonJS({
    "../../app/frida_hooks/sensitive_apis.js"() {
      init_node_globals();
      (function() {
        "use strict";
        ...
        function eventId() {
          ...
          return "event-" + String(Date.now()) + "-" + String(Math.floor(Math.random() * 1e9));
        }
        function threadInfo() {
          if (ThreadClass === null) {
        ...
        function emitConsent(source) {
          emitControl("consent_granted", {
            ...
            metadata: {
              monotonic_source: SystemClock === null ? "frida_script_clock_pending" : "android.os.SystemClock.elapsedRealtime"
            }
          });
          return true;
        }
        ...
        function installJavaHooks() {
          if (javaHooksInstalled || typeof Java === "undefined" || !Java.available) {
            return false;
          }
          ...
          Java.perform(function() {
            ...
            try {
              ...
              secureGetString.implementation = function(resolver, name) {
                ...
                if (kind !== null) {
                  var present = result !== null && String(result).length > 0;
                  emitEvent({
                    ...
                    value_token: present ? "redacted:withheld-at-source" : null,
                    metadata: {
            ...
            emitControl("hook_status", {
              ...
              metadata: {
                monotonic_source: "android.os.SystemClock.elapsedRealtime"
              }
            });
          });
          return true;
        ...
        emitControl("hook_ready", {
          ...
          metadata: {
            ...
            java_runtime: typeof Java === "undefined" ? "absent" : Java.available ? "available" : "pending"
          }
        });
        waitForJavaRuntime();
      })();
  ...
  // agent_main.js
  init_node_globals();
  var javaBridgeModule = (init_frida_java_bridge(), __toCommonJS(frida_java_bridge_exports));
  var Java2 = javaBridgeModule && javaBridgeModule.default !== void 0 ? javaBridgeModule.default : javaBridgeModule;
  globalThis.Java = Java2;
  require_sensitive_apis();
})();
